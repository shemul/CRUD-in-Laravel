...
<html lang="en">
	...
	<div class="welcome">
		...
		<h1>Welcome to CRUD in Laravel</h1>
		<a href="app/create"><button href="" type="button" class="btn btn-primary">Create</button></a>
		<a href="app/update"><button href="" type="button" class="btn btn-primary">Update</button></a>
		<a href="app/delete"><button href="" type="button" class="btn btn-primary">delete</button></a>
		<a href="app/view"><button href="" type="button" class="btn btn-primary">View</button></a>
