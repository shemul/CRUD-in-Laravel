...
<html lang="en">
	...
	<div class="welcome">
		...
		<a href="/create"><button href="" type="button" class="btn btn-primary">Create</button></a>
		<a href="/update"><button href="" type="button" class="btn btn-primary">Update</button></a>
		<a href="/delete"><button href="" type="button" class="btn btn-primary">delete</button></a>
		<a href="/view"><button href="" type="button" class="btn btn-primary">View</button></a>
